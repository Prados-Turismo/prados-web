...
interface IModalRegisterContaBancaria {
  handleClose: () => void;
}

const ModalRegisterContabancaria = ({
  handleClose,
}: IModalRegisterContaBancaria) => {
  const { user } = useGlobal();
  const { createContaBancaria } = useContaBancaria();
  ...
  const { mutate, isLoading } = createContaBancaria(reset, handleClose);
