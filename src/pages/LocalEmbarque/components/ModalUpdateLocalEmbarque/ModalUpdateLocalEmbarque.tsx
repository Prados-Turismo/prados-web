...
interface IModalUpdateLocalEmbarque {
  handleClose: () => void
  data: ILocalEmbarque
}

const ModalUpdateLocalEmbarque = ({
  handleClose,
  data
}: IModalUpdateLocalEmbarque) => {
  const { user } = useGlobal();
  const { updateLocalEmbarque } = useLocalEmbarque();
  ...
  const { mutate, isLoading } = updateLocalEmbarque(reset, handleClose);
...
export default ModalUpdateLocalEmbarque;
