...
import { IRelatorioFornecedorList } from "./types";
import SelectAsyncPaginate from "../../../components/SelectAsyncPaginate";
import useFornecedor from "../../../hooks/useFornecedor";

const RelatorioFornecedorList = ({
  fornecedorResponse,
  currentPage,
  setCurrentPage,
  codigoFornecedor,
  ...
  const { fornecedorPromiseOptions } = useFornecedor()

  const { data, count, isLoading } = fornecedorResponse
        ...
        <Flex width="100%" gap="15px" alignItems="flex-end" flexWrap="wrap">
          <Flex flexDirection="column" gap="5px" width="200px">
            <SelectAsyncPaginate
              ...
              promiseOptions={fornecedorPromiseOptions}
              handleChange={(option) => {
                setFornecedor(option);
              }}
            />
          </Flex>
...
export default RelatorioFornecedorList;
