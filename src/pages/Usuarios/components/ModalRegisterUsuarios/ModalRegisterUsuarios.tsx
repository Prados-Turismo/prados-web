...
interface IModalRegisterUsuario {
  handleClose: () => void;
}

const ModalRegisterUsuarios = ({
  handleClose,
}: IModalRegisterUsuario) => {
  ...
  const { mutate, isLoading } = createUsuario(reset, handleClose);
...
export default ModalRegisterUsuarios;
